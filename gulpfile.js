...
// ===================== Production Build =====================
gulp.task('build', gulpSequence('clean', 'scripts', 'html', 'styles', 'copy', 'webp', 'gzip'));
...
// ===================== Scripts =====================
gulp.task('scripts', gulpSequence('script:index', 'script:restaurant'));
...
// ===================== Gzip Build =====================
gulp.task('gzip', gulpSequence('gzip-html', 'gzip-css', 'gzip-js'));
